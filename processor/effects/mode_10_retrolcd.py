...
def apply_retrolcd(img, w, h, out_dir, base_name):
    ...
    palettes = [
        [[15, 56, 15], [48, 98, 48], [139, 172, 15], [155, 188, 15]], # 0
        
        [[0, 10, 30], [0, 60, 120], [0, 120, 200], [120, 200, 255]], # 1
        
        [[0, 0, 0], [0, 0, 80], [0, 0, 180], [20, 20, 255]], # 2

        [[5, 20, 5], [10, 80, 10], [30, 180, 30], [180, 255, 180]], # 3

        [[50, 10, 40], [120, 40, 120], [200, 200, 50], [255, 200, 255]], # 4

        [[25, 25, 25], [80, 80, 80], [160, 160, 160], [220, 225, 230]], # 5

        [[59, 9, 18], [124, 12, 130], [67, 20, 186], [25, 107, 250]], # 6

        [[40, 20, 0], [100, 60, 0], [180, 140, 50], [255, 240, 200]], # 7
        
        [[10, 0, 20], [40, 10, 60], [80, 20, 120], [180, 150, 255]], # 8

        [[40, 20, 0], [100, 100, 0], [200, 255, 100], [255, 255, 200]], # 9

        [[10, 10, 10], [99, 99, 90], [151, 156, 98], [220, 227, 141]], # 10

        [[12, 18, 8], [40, 70, 20], [95, 150, 60], [190, 235, 150]], # 11

        [[20, 5, 35], [70, 25, 90], [140, 60, 170], [230, 180, 245]], # 12

        [[0, 25, 35], [20, 80, 110], [60, 150, 190], [180, 240, 255]] # 13
    ]
